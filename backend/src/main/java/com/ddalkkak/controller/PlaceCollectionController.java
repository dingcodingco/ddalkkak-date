...
public class PlaceCollectionController {
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "500", description = "배치 작업 시작 실패")
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "재큐레이션 시작 성공"),
        @ApiResponse(responseCode = "500", description = "재큐레이션 시작 실패")
    })
